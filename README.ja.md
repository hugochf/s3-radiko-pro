...
- (開発中)**SD カードへの録音**とオンデバイス再生

## ハードウェア

**ボード:** lcdwiki ES3C28P — ESP32-S3(16 MB QIO flash、8 MB OPI PSRAM)、ILI9341 320×240 SPI LCD、FT6336G 静電容量タッチ、ES8311 コーデック + FM8002E アンプ。~US$10〜15 の汎用ボード(複数の名称で販売)。スピーカーと Li-Po バッテリーは別売りです。
